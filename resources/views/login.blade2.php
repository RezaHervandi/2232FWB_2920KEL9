...
<body>
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="{{url('/')}}" class ="navbar-brand">Travel Kok Loka</a>
            </div>
        </div>
    </nav>
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <footer class="container">
			...
			created by <a href="https://www.facebook.com/rizky.Kiwa"><span><i class="fa fa-facebook" style="color:#1da1f2"></i> @Kelompok6</span></a>
			<!--/ Please dont delete this -->
        </footer>
    </nav>
